...
console.log('🚀 Starting Advanced Puppeteer Testing for devices...');

async function testMaskServiceDevices() {
    let browser;
    let page;
    ...
    try {
        ...
        const backendUrl = 'http://maskservice-devices-backend:8207/health';
        ...
        const frontendUrl = 'http://maskservice-devices-frontend';
        ...
        await page.screenshot({ 
            path: '/tmp/devices-screenshot.png',
            fullPage: true 
        });
        console.log('✅ Screenshot saved to /tmp/devices-screenshot.png');
...
// Run the test
testMaskServiceDevices()
    .then(success => {
        console.log(`\n🏁 Testing completed for devices: ${success ? 'SUCCESS' : 'FAILED'}`);
