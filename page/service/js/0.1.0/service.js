...
describe('serviceMenu', () => {
  it('should have correct metadata', () => {
    expect(component.metadata.name).toBe('serviceMenu');
  ...
  it('should initialize successfully', async () => {
    ...
    expect(result.message).toContain('serviceMenu');
  });
  ...
  it('should handle GET_METADATA action', () => {
    ...
    expect(result.success).toBe(true);
    expect(result.data.name).toBe('serviceMenu');
  });
