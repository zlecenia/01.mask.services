...
console.log('🚀 Starting Advanced Puppeteer Testing for workshop...');

async function testMaskServiceWorkshop() {
    let browser;
    let page;
    ...
    try {
        ...
        const backendUrl = 'http://maskservice-workshop-backend:8211/health';
        ...
        const frontendUrl = 'http://maskservice-workshop-frontend';
        ...
        const htmlAnalysis = await page.evaluate(() => {
            ...
            const hasCustomScript = document.querySelector(`script[src*="workshop"]`) !== null;
            const hasCustomCSS = document.querySelector(`link[href*="workshop"]`) !== null;
        ...
        console.log(`  Custom workshop.js: ${htmlAnalysis.hasCustomScript ? '✅' : '❌'}`);
        console.log(`  Custom workshop.css: ${htmlAnalysis.hasCustomCSS ? '✅' : '❌'}`);
        console.log(`  Body Content Length: ${htmlAnalysis.bodyContentLength} chars`);
        
        // Take screenshot for debugging
        console.log('📸 Taking screenshot for debugging...');
        await page.screenshot({ 
            path: '/tmp/workshop-screenshot.png',
            fullPage: true 
        });
        console.log('✅ Screenshot saved to /tmp/workshop-screenshot.png');
...
// Run the test
testMaskServiceWorkshop()
    .then(success => {
        console.log(`\n🏁 Testing completed for workshop: ${success ? 'SUCCESS' : 'FAILED'}`);
