...
console.log('🚀 Starting Advanced Puppeteer Testing for settings...');

async function testMaskServiceSettings() {
    let browser;
    let page;
    ...
    try {
        ...
        const backendUrl = 'http://maskservice-settings-backend:8210/health';
        ...
        const frontendUrl = 'http://maskservice-settings-frontend';
        ...
        await page.screenshot({ 
            path: '/tmp/settings-screenshot.png',
            fullPage: true 
        });
        console.log('✅ Screenshot saved to /tmp/settings-screenshot.png');
...
// Run the test
testMaskServiceSettings()
    .then(success => {
        console.log(`\n🏁 Testing completed for settings: ${success ? 'SUCCESS' : 'FAILED'}`);
